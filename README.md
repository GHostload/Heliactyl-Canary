...
Heliactyl itself is great but makes it hard for 3rd Party Developers to expand without modifying the base that's why I created this fork of it.
...
```bash
$ wget https://heliactyl.cloud/Canary/git-xxxxx/installer.sh | bash sh 
```
...
$ ufw allow 80
$ ufw allow 443
$ certbot certonly -d <Your Heliactyl Canary Domain>
...
Keep or make a backup of the following file(s):
```css
...
Fork this Project and make your changes after that create a pull request or create a issue and mark it as a suggestion.
